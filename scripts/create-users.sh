...
# ---------------------------------------------------------------
# Matrix users (only if local Synapse is enabled)
# ---------------------------------------------------------------
if [ "${CONCLAVE_SYNAPSE_ENABLED:-true}" = "true" ]; then
    ...
    echo "Synapse disabled, skipping Matrix user creation."
fi

# ---------------------------------------------------------------
# Planka users (only if local Planka is enabled)
# ---------------------------------------------------------------
...
" 2>&1 || echo "Work project creation failed (may already exist)."
    ...
    echo "Planka disabled, skipping Planka user creation."
fi
